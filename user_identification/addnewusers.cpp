...
void AddNewUsers::on_add_new_user_clicked()
{
    ...
    if (data.find(log)!= data.end()) {
        ...
        QMessageBox::information(this, "Добавление пользователя", "Логин должен состоять минимум из 8 символов. Пароль должен состоять минимум из 12 символов.");
        ...
        users_data->AddCurrentUser(log, pass);
